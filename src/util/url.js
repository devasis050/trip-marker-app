...
const REDIRECT_URL = 'https://tripmarker.herokuapp.com/oauth/redirect'; //'http://localhost:3000/oauth/redirect';
const RESPONSE_TYPE = 'code';
const FB_OAUTH_URL = 'https://www.facebook.com/v6.0/dialog/oauth';
const TRIP_MARKER_SERVRE_URL = 'https://tripmarker-server.herokuapp.com'; //'http://localhost:8080';
